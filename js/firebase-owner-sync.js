...
async function loadFirebaseSdk(){
  ...
  ({getAuth, setPersistence, browserLocalPersistence, onAuthStateChanged, signInWithEmailAndPassword, signOut} = authModule);
...
async function loginOwner(event){
  ...
  try{
    ...
    console.error(error);
    showMessage("No fue posible iniciar sesión. Verifica el correo, la contraseña y que Email/Password esté habilitado.", "error");
  }finally{
