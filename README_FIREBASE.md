...
## Corrección de clave API (30/07/2026)

La clave web fue actualizada exactamente con el valor entregado por Firebase.
Se corrigió la confusión entre la letra mayúscula `O` y el número `0` en `apiKey`.
Los archivos HTML y módulos usan una nueva versión de caché (`firebase3`) para que GitHub Pages cargue la configuración corregida.
